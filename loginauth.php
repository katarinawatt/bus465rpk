        ...
        <?php
           ...
           $db = mysqli_connect("localhost", "kaw19", "1234", "bus465_project");
            ...
            if (isset($_POST["upload"])) {
                ...
                $sql = "SELECT userEmailAddress FROM registration WHERE userEmailAddress = '$userEmailAddress' 
                ...
                if ($count == 1) {
                    session_register("userEmailAddress");
                    $_SESSION['userid'] = $userEmailAddress;
